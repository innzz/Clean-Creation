...
function OnlineMenu() {
  const cardsDetails = [
    ...
    },
    {
      ...
      description:
        "Whole Wheat Oatmeal and Chocolate Chip Lactation Cookies. Highly effective in helping to",
      calories: 170,
    },
    {
      ...
      description:
        "JUST EGG, Chorizo spiced tofu, Onion, Jalapeno Topped with Green Onion and Fresh Tomato in",
      calories: 360,
    },
    {
      ...
      description:
        "Whole Eggs, Black Beans, White Cheddar, Tomato over Baby Spinach Served with Chipotle Dip",
      calories: 380,
    },
    {
      ...
      description:
        "Whole Eggs, Black Beans, Turkey Chorizo, Jalapeno, White Cheddar, Tomato on Whole Wheat Tortilla",
      calories: 430,
    },
    {
    ...
    },
    {
      ...
      description:
        "Overnight oats with almond milk, spices, raisins, Yogurt and pecans",
      calories: 640,
    },
    {
    ...
    },
    {
      ...
      description:
        "House Chicken Salad, over Mixed Greens served with Honey Mustard and Fresh Fruit",
      calories: 430,
      premium: "premium",
    },
  ];
                ...
                <div className={styles.card} key={i}>
                  ...
                  <div className={styles.rightContent}>
                    <div className={styles.cardDescription}>
                      <p className={styles.menuTitle}>{val.title}</p>
