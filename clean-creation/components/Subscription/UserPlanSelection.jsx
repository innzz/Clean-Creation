...
function UserPlanSelection() {
  const yourPlan = [
    {
      ...
      btnPrice: parseFloat(65.0),
      btnDesc:
        "This plan combines every menu option we offer. It's perfect if you love to mix your meal preferences like low carb, vegan, vegetarian, pescatarian or lifestyle. ***PLEASE NOTE: IN ORDER TO AVOID DUPLICATES OF VARIATIONS YOU MUST SELECT YOUR MEALS WITHIN THE PLAN***",
    },
    {
      btnTxt: "The Lifestyle Plan",
      btnPrice: parseFloat(52.5),
      btnDesc:
        "Every meal in this plan was created to promote a healthy lifestyle. Select from the Normal portion (4-5 oz of lean protein, 2-4 oz of complex carbohydrates and 4-6 oz of nutrient rich vegetables) or Muscle Builder portion (6-8 oz of lean protein, 3-6 oz of complex carbohydrates and 6-8 oz of nutrient rich vegetables)",
    },
    {
      btnTxt: "The Low Carb Plan",
      btnPrice: parseFloat(67.5),
      btnDesc:
  ...
  const handleMealsPerDay = (val) => {
    setoverView({ ...overView, meelsPerDay: val, deliveryDate: "" });
  };
        ...
        <div className={styles.inputContainer}>
          <InputGroup className={`mb-3 ${styles.input}`}>
            <span className={styles.inputIcon}>
              <IoIosWarning style={{ color: "orange" }} size={"30px"} />
            </span>
            <FormControl
            ...
            <div className={styles.leftSection}>
              <div className={styles.cards}>
                <div className={styles.card}>
                  ...
                  <div className={styles.desc}>{yourPlanBtnDesc}</div>
                </div>
                <div className={styles.card}>
                  <div className={styles.heading}>
                ...
                <div className={styles.card}>
                  ...
                  <div
                    ...
                    style={
                      overView.portionSize !== "" ? {} : { opacity: "0.2" }
                    }
                  >
                ...
                <div className={styles.card}>
                  ...
                  <div
                    className={styles.buttonsGroup}
                    style={
                      overView.billingRenewal && overView.portionSize !== ""
                        ? {}
                        : { opacity: "0.2" }
                    }
                  >
                ...
                <div className={styles.card}>
                  ...
                  <div
                    ...
                    style={
                      overView.plan2 &&
                      overView.portionSize &&
                      overView.billingRenewal !== ""
                        ? {}
                        : { opacity: "0.2" }
                    }
                  >
              ...
              <div className={styles.rightInnerContainer}>
                ...
                <div className={styles.overViewItem}>
                  ...
                  {overView.billingRenewal === "" ? (
                    ...
                    <div>
                      <li>Billing Renewal Cycle</li>
                      <h3>{overView.billingRenewal}</h3>
                    </div>
                  )}
                  {overView.plan2 === "" ? (
                    ""
                  ...
                  {overView.daysPerWeek === "" ? (
                    ...
                    <div>
                      <li>Days per week</li>
                      <h3>{overView.daysPerWeek}</h3>
                    </div>
                  )}
                  {overView.meelsPerDay === "" ? (
                    ""
                  ) : (
                    <div>
                      <li>Meals per day</li>
                      <h3>{overView.meelsPerDay}</h3>
                    </div>
                  )}
                  {subTotal === "" ? (
                    ""
                    ...
                    <div>
                      ...
                      <h3>${parseFloat(subTotal)}</h3>
                    </div>
                  )}
                  {overView.deliveryDate === "" ? (
                    ""
                  ) : (
                    <div>
                      <li>Starting on</li>
                      <h3>2022-06-{overView.deliveryDate}</h3>
                    </div>
                  )}
                </div>
        ...
        <div className={styles.buttonWrapper}>
          <div className={styles.leftButtonGroup}>
            <div className={styles.button}>
              <GiMeal size={"25px"} style={{ marginRight: "8px" }} />
              Select Your Meals
            </div>
            <div className={styles.button}>
              <FaShoppingCart size={"25px"} style={{ marginRight: "8px" }} />
              Go to Cart
            </div>
          </div>
        </div>
