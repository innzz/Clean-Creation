...
=======
  ...
  const handlePlan2 = (val) => {
    setoverView({ ...overView, plan2: val, daysPerWeek: "", meelsPerDay: "" });
  };
  const handleDaysPerWeek = (val) => {
    setoverView({ ...overView, daysPerWeek: val, meelsPerDay: "" });
  };
  const handleMealsPerDay = (val) => {
    setoverView({ ...overView, meelsPerDay: val });
  };
...
>>>>>>> 8f3b392 (Made Some Component Dynamic and Useful for easy API Implementation.)
