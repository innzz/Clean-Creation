  ...
  render() {
    return (
      <div className="container">
          ...
          <div className="grid lg:grid-cols-3 lg:gap-4">
            ...
            <div className="bg-purple-500 grid place-content-center justify-items-center rounded-2xl h-60 lg:w-auto w-80 p-3">
              <p className="text-white text-center lg:text-lg font-semibold">
                Do not forget to set your preferences so our system can
                automatically filter meals that you had want to eat!
              </p>
              <img
                className="lg:h-32 h-20"
                src="https://cleancreations.com/assets/images/alert_banner.svg"
                alt=""
              />
            </div>
          </div>
        ...
        >
          <DialogTitle>
            <p className="text-2xl font-bold text-center text-serif">
              SELECT YOUR ALLERGENS
            </p>
          </DialogTitle>
          <DialogContent>
            ...
            <div className="grid grid-cols-5 gap-2">
              <button className="bg-gray-200 text-xs rounded-lg p-1 ">
                Dairy (Lactose)
              </button>
              <button className="bg-gray-200 text-xs rounded-lg p-2 ">
                Eggs
              </button>
              <button className="bg-gray-200 text-xs rounded-lg p-2 ">
                Fish
          ...
          <DialogContent className=" -mt-4 ">
            <div className="grid grid-cols-2 divide-x">
              <div
                ...
                className="hover:bg-gray-500 p-3 -mt-5 -mb-5 -ml-6 grid hover:text-white text-gray-400 place-content-center"
              >
              ...
              <div
                ...
                className="hover:bg-gray-500 p-3 -mt-5 -mb-5 -mr-6 grid hover:text-white text-gray-400 place-content-center"
              >
