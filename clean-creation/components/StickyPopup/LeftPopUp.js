        ...
        return (
            <div>
                <div className={this.state.hidden} onClick={this.handleClick}>
                    <div className="border shadow fixed bg-white px-10 -ml-20 w-80 h-24 rotate-45 -bottom-16 left-0" style={{zIndex:'20'}}>
                    ...
                    <DialogContent>
                        <div className="grid grid-cols-2 ">
                            <div className="-ml-3 pr-1">
                                <p className="text-3xl text-center mt-10  font-bold">UNLOCK <span className="text-teal-500">$20 OFF</span> YOUR FIRST ORDER</p>
