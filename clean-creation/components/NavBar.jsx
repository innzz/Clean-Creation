                ...
                <Navbar  className="bg-white" collapseOnSelect expand="lg">
                    <Container>
                        ...
                        <Navbar.Collapse className="justify-content-center">
                            <img src="https://cleancreations.com/data/config/client_logo.png?md=f341c123680491a1ca69dd7a67ca190e" alt="" style={{ height: "50px", width: "70px", marginTop: "5px" }} />
                        </Navbar.Collapse>
                        <Navbar.Collapse className="justify-content-end">
                            <Dropdown>
                                <Dropdown.Toggle style={{ backgroundColor: "green" }} id="dropdown-basic">
                                    Shop
                                </Dropdown.Toggle>

                                <Dropdown.Menu style={{ lineHeight: "35px", padding: "10px" }}>
                                    <Dropdown.Item href="#/action-1">Subscription Meal Selection</Dropdown.Item>
                                    <Dropdown.Item href="#/action-2">À la Carte</Dropdown.Item>
                                    <Dropdown.Item href="#/action-3">Proteins by the Pound</Dropdown.Item>
                                    <Dropdown.Item href="#/action-3">Custom Meal Builder</Dropdown.Item>
