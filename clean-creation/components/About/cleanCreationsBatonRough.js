        ...
        return (
            <div>
                <div className="container">
                    ...
                    <p className=" text-gray-700">Having healthy, delicious meals prepared for you by Clean Creations, Baton Rouge sounds great - but <span className="font-bold">how do you get started</span>? All you have to do is click the “<Link className="no-underline cursor-pointer" href="/">Get Started</Link>” link on our homepage to set up an account. Once you create a profile, you can then visit the “Order” tab on our homepage to begin placing your order. It’s as easy as that!</p>
                    ...
                    <div className="grid place-content-center">
                    <button href="/screens/Blog/read" className="mt-4  no-underline inline-flex items-center py-2 px-3 md:px-10 text-xl font-bold text-center text-white bg-lime-400 mb-10 rounded-lg">
