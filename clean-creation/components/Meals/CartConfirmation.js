            ...
            <div>
                <div className="container">
                    ...
                    <div className="flex gap-2 px-10 lg:px-0 place-content-center lg:place-content-start">
                        <Image src="/watch.svg" alt="" />
                        <p className="font-semibold text-gray-700">Wednesday, Jun 08, 2022</p>
                        <Image src="/rightArrow.svg" alt="" />
                        <div className="flex items-center -mt-4 ">
                            <input onClick={() => { this.setState({ delivery: true }) }} id="default-radio-1" type="radio" value="" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                            <label htmlFor="default-radio-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Delivery</label>
                        </div>
                        <div className="flex items-center -mt-4 ">
                            <input onClick={() => { this.setState({ pickup: true }) }} checked id="default-radio-2" type="radio" value="" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                            <label htmlFor="default-radio-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pickup</label>
                        </div>
                    </div>
                    <div className="mb-10 p-3 bg-gray-200 border-l-[7px] border-red-600 lg:leading-3" >
                        ...
                        <Link href="/" className="text-gray-500">Edit</Link>
                    </div>
                    <p className="text-2xl text-gray-800 font-bold pt-5">Payment Method</p>
                    <div className="flex items-center -mt-4 ">
                        <input checked id="default-radio-2" type="radio" value="" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                        <label htmlFor="default-radio-2" className="ml-2 text-lg font-normal text-gray-600 dark:text-gray-300">Credit Card</label>
                    </div>
                ...
                <Dialog fullWidth
                    ...
                    <DialogContent>
                        ...
                        <div className="flex items-center  ">
                            <input checked id="default-radio-2" type="radio" value="" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                            <label htmlFor="default-radio-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Save address to profile and use for all future deliveries</label>
                        </div>
                    </DialogContent>
                    <hr />
